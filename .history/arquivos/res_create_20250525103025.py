...
def res_create():
    ...
    while execucao_2: #Executado enquanto o código não encontrar um cadastro válido
        ...
        if validador(insert_1, insert_2, insert_4, insert_5): #Checa se todos os valores insiredos são válidos
            print('Cadastro realizado com sucesso.')
            restaurant = Restaurante(insert_1, insert_2, insert_4, insert_5) #Cria objeto
            dados = []
