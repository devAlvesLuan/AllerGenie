...
def pesquisa_prato(pesquisa):
    ...
    if resultados:
        ...
        for nome_restaurante, nome_prato, descricao, preco in resultados:
            print(Util.pinta(f"||> Nome restaurante: {nome_restaurante}", 'branco_brilhante'))
    print(Util.pinta(f"||> Prato: {nome_prato}", 'branco_brilhante'))
    print(Util.pinta(f"||> Descrição: {descricao}", 'branco_brilhante'))
    print(Util.pinta(f"||> Preço: {preco} R$", 'branco_brilhante'))
            print("----------------------------------------------------------", 'branco_brilhante')))
    else:
        print(Utils.pinta("Nada encontrado . . .", 'vermelho'))
