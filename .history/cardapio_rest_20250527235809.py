...
def add_prato(usuario_encontrado):
    ...
    Parâmetros:
    cardapio (dict): Dicionário que representa o cardápio do restaurante.
    nome_prato (str): Nome do prato a ser adicionado.
    descricao (str): Descrição detalhada do prato.
    palavras_chave (list): Lista de palavras-chave relacionadas ao prato.
    preco (float): Preço do prato.

    Retorna:
    dict: Cardápio atualizado com o novo prato.
