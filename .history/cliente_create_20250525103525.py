...
def cliente_create():
    ...
    while execucao_2: #Executado enquanto o código não encontrar um cadastro válido
        insert_1 = input('----------------------------\n  Insira seu primeiro nome e sobrenome:')
        ...
        if validador(insert_1, insert_4, insert_5): #Checa se todos os valores insiredos são válidos
            print('Cadastro realizado com sucesso.')
            cliente = Cliente(insert_1, insert_4, insert_5) #Cria objeto
            dados = []
            ...
            dados.append(cliente.criador_dic()) #Adiciona dados ao arquivo
