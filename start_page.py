...
def main():
    def opcoes_cad_login(exe, usuario,repositorio_json, modulo_cadastro, modulo_menu):
        while exe:
    ...
    execucao = True
    if empresa:
        opcoes_cad_login(execucao, 'restaurantes', 'restaurantes.json', res_create, menu_empresa)
    if cliente:
        opcoes_cad_login(execucao, 'clientes', 'clientes.json', cliente_create, menu_cliente)
